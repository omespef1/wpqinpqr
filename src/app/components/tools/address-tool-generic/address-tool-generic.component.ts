...
@Component({
  selector: 'app-address-tool-generic',
  templateUrl: './address-tool-generic.component.html',
  styleUrls: ['./address-tool-generic.component.css']
})
export class AddressToolGenericComponent implements OnInit {
